...
export const experience: Experience[] = [
  {
    ...
    summary: "Build native macOS apps in Swift that power Apple's CRM workflows. Notable projects include on-device speech transcription, a real-time WebSocket notification system, and an internal AI assistant application. I also build and maintain foundational Swift frameworks used across multiple teams. Won first place out of 200 teams in the 2026 internal hackathon.",
  },
  {
    company: "Amazon",
  ...
  },
  {
    ...
    period: "Jun - Aug 2021",
    summary: "Built a Python web application to visualize high-dimensional lung cancer data and developed a statistical gene-correlation tool used by experimental biologists. Co-authored a <a href=\"https://ascopubs.org/doi/10.1200/CCI.22.00040\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"text-accent hover:text-accent-hover\">published paper</a> in JCO Clinical Cancer Informatics.",
  },
];
...
export const socialIcons: Record<string, string> = {
  ...
  medium: `<svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="currentColor"><path d="M13.54 12a6.8 6.8 0 01-6.77 6.82A6.8 6.8 0 010 12a6.8 6.8 0 016.77-6.82A6.8 6.8 0 0113.54 12zM20.96 12c0 3.54-1.51 6.42-3.38 6.42-1.87 0-3.39-2.88-3.39-6.42s1.52-6.42 3.39-6.42 3.38 2.88 3.38 6.42M24 12c0 3.17-.53 5.75-1.19 5.75-.66 0-1.19-2.58-1.19-5.75s.53-5.75 1.19-5.75C23.47 6.25 24 8.83 24 12z"/></svg>`,
};
